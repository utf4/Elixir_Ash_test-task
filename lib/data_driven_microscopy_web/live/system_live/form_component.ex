defmodule DataDrivenMicroscopyWeb.SystemLive.FormComponent do
  ...
  def render(assigns) do
    ...
    <div>
      <.simple_form :let={f} for={@form} phx-change="validate" phx-target={@myself} phx-submit="save">
        ...
        <.input field={{f, :manufacturor}} type="select" label="Manufacturer" options={["Nikon", "Leica" ,"Zeiss", "Olympus"]} /> 
        <:actions>
